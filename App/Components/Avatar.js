  ...
  render () {
    ...
    return (
      ...
      >
        ...
        <View style={{ marginTop: 15, padding: 10, flex: 1, flexDirection: "row", alignItems: 'flex-start', justifyContent: 'flex-start' }}>
          <Icon size={20} name='upload' color={Colors.background} type='font-awesome'/>
          <Text style={{ marginLeft: 10, paddingTop: 2, color: Colors.background, fontWeight: "bold"}}>UPLOAD</Text>
        </View>
      </TouchableOpacity>
    )
  }
