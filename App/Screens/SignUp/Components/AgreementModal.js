...
const getAgreementModal = (isAgreementModalOpen, closeAgreementModal) => (
      ...
      <View style={styles.modalContainer}>
        <View style={styles.innerContainer}>
          ...
          <Text style={{ textAlign: 'justify', paddingBottom: 10 }}>
            ...
            ds which don not look even slightly believable.
            If you are going to use a passage of Lorem Ipsum, you need to
            be sure there is not anything embarrassing hidden in the midd
...
export default getAgreementModal;
