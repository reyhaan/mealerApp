...
import style from './Styles/OrderHistory.style'
...
import {Header, Left, Body, Right, Title, Form, Item, Input, Label, Button} from 'native-base';
...
class OrderHistory extends Component {
    ...
    renderHistory = () => {
        ...
        if (orders && orders.length > 0) {
            return (
                <FlatList data={orders} renderItem={({item}) => <OrderHistoryList order={item}/>}/>
            )
        } else {
            return (
